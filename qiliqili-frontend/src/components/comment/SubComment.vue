...
import {getMoreReply} from '@/apis/comment.js'
export default {
    name: "SubComment",
    components: {
        VAvatar,
    ...
    methods: {
        ...
        async moreComment() {
          ...
          await getMoreReply(params).then((res) => {
            this.$emit("get-more-comment", res.data);
        ...
        //       id: this.replies[0].rootId
        //     }
        //   const res1 = await getMoreReply(params).then((res) => {
        //
        //     })
        //   console.log(res1)
        //   //   return res.data;
